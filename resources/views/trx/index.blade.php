...
<div class="container-fluid" style="margin-bottom: 60px;">
    <form action="{{ route('trx.store') }}" method="post">
        ...
        <input type="hidden" name="gamesno"  value="{{$bets[0]->gamesno}}">
            ...
            <div class="col-md-12">
                <div class="white_shd full margin_bottom_30">
                    ...
                    <div class="row ml-4 d-flex" style="margin-bottom: 20px;">
                        ...
                        <div class="col-md-3 form-group d-flex">
                            <input type="number" min="0" max="9" name="number" class="form-control" placeholder="Result">
                        </div>
    ...
    <script>
        ...
        function updateBets(bets) {
            ...
            bets.forEach(item => {
                ...
                amountdetailHTML += '</div>';
                gmsno ='<b style="font-size: 50px; "> Period :' + item.gamesno + '</b>';
            });
