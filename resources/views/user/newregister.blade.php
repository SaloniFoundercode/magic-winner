   ...
   <body style="font-size: 12px;">
      <div id="app" data-v-app="" style=":#D3D3D3">
         ...
         <div class="imagebackground">
            ...
            <div data-v-183fb3f9="" data-v-dba00bcf="" style=": white; color:grey" class="dropdown">
            <div data-v-183fb3f9="" class="dropdown__value" style="background:white;border-radius:10px">
            <span data-v-183fb3f9="" style="color: black;">+91</span>
            <i data-v-183fb3f9="" style="color: Gray;" class="van-badge__wrapper van-icon van-icon-arrow-down">
            </i>
            </div>
            </div>
            <input class="bgblack" data-v-dba00bcf="" type="number" style=": white; color:black;background:white" id="mobileNumber" name="mobile" placeholder="Only 10 numbers allowed" maxlength="10"  required 
               pattern="\d{10}" 
               	...
               	xhrSend.onreadystatechange = function() { 
               		if (xhrSend.readyState === 4) {
               			if (xhrSend.status === 200) {
							...
							// Set the message color to white
            ...
            <div data-v-327ab6b4="" class="tip"><!----><!----></div><!---->
		...
		<i id="eye-icon" class="fa-solid fa-eye-slash fa-xl cpassword" onclick="togglePasswordVisibility()" style="margin-left:-40"></i>
            ...
            <div data-v-327ab6b4="" class="register__container-invitation__input">
            <input class="inviteCode" data-v-327ab6b4="" name="referral_code" value="{{$ref_id->referral_code}}" type="text" auto-complete="new-password" style="color:black;background:white"
